...
$sql= "DELETE FROM dexigner WHERE schoolname='$textfield'";
mysqli_query($connect, $sql);
echo "<meta http-equiv='refresh' content='0;url=dezigner.php'>";
}
...
<table class="table">
  ...
  <form class="form-inline" method="POST" action="dezigner.php">
<div>
