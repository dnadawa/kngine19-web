...
$sql= "DELETE FROM codecom WHERE schoolname='$textfield'";
mysqli_query($connect, $sql);
echo "<meta http-equiv='refresh' content='0;url=codecom.php'>";
}
...
<table class="table">
  ...
  <form class="form-inline" method="POST" action="codecom.php">
<div>
